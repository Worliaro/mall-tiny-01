...
/**
 * @Classname UmsAdminSeviceImpl
 * @Description ToDo
 * @Date 2020/7/6 9:26
 * @Creater by weiyao
 */
@Service
public class UmsAdminSeviceImpl implements UmsAdminService {

    private static final Logger LOGGER = LoggerFactory.getLogger(UmsAdminSeviceImpl.class);
